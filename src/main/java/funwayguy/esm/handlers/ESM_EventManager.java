...
{	
	...
	public void onEntityJoinWorld(EntityJoinWorldEvent event)
	{
		...
		} else if(event.entity instanceof EntityZombie)
		{
			...
			} else if(ESM_Settings.DemolitionZombies && event.world.rand.nextFloat() < 0.1F && (ESM_Settings.ZombieEnhancementsOnlyWhenSiegeAllowed ? ESM_Utils.isSiegeAllowed(event.world.getWorldTime()) : true))
			{
